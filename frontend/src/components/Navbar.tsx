...
export function Navbar({ address, connecting, onConnect }: NavbarProps) {
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <button
          onClick={onConnect}
          disabled={connecting}
          className={`text-sm font-medium px-5 py-2.5 rounded-lg transition-all duration-200 disabled:opacity-50 ${
            isConnected
